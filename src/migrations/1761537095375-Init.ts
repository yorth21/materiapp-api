...
export class Init1761537095375 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "courses_in_curriculum" ("id" SERIAL NOT NULL, "semester" integer NOT NULL, "calendar" character(1), "credits" integer NOT NULL, "is_active" boolean NOT NULL DEFAULT true, "curriculum_id" integer NOT NULL, "course_id" integer NOT NULL, "prerequisite_id" integer, CONSTRAINT "PK_da51d767e795c627a41a0b4c27f" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "student_curricula" ("id" SERIAL NOT NULL, "is_active" boolean NOT NULL DEFAULT true, "student_id" uuid NOT NULL, "curriculum_id" integer NOT NULL, CONSTRAINT "PK_192dde3473dbf6ea6bb12d8719e" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`ALTER TABLE "student_curricula" ADD CONSTRAINT "FK_ca4c67376310f69878379a8ab38" FOREIGN KEY ("student_id") REFERENCES "students"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "student_curricula" DROP CONSTRAINT "FK_ca4c67376310f69878379a8ab38"`);
